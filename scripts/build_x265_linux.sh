...
echo "=== [x265 Linux] Step 1: Configuring 8-bit, 10-bit, and 12-bit in parallel ==="
...
echo "=== [x265 Linux] Step 2: Building 8-bit, 10-bit, and 12-bit x265 in parallel ==="
...
echo "=== [x265 Linux] Step 3: Copying build artifacts to cache ==="
...
echo "=== [x265 Linux] Multi-depth x265 build completed successfully! ==="
