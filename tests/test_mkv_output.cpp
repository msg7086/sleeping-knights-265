...
TEST_CASE("MkvOutput handles invalid destination gracefully", "[output][mkv]") {
    sk265::pipeline::output::MkvOutput output;
...
TEST_CASE("MkvOutput initializes MKV container, writes NALs and finishes cleanly", "[output][mkv]") {
    std::string testPath = "test_output_mux.mkv";
